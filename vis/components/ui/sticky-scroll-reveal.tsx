...
export const StickyScroll = ({
    ...
    const { scrollYProgress } = useScroll({
        // Uncomment line 22 and comment line 23 if you  want the overflow container and want to have it change on the entire page scroll
        // target: ref
        container: ref,
